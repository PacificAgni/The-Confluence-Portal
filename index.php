...
<head>
    ...
    <!-- /meta tags -->
    <!-- custom style sheet -->
    <link href="web/css/style.css?v=1" rel="stylesheet" type="text/css" />
    <!-- /custom style sheet -->
    <!-- fontawesome css -->
    <link href="web/css/fontawesome-all.css?$v=1" rel="stylesheet" />
    <!-- /fontawesome css -->
    <!-- google fonts-->
...
<body>
    <h1>Hostel Room Allocation Systems</h1>
